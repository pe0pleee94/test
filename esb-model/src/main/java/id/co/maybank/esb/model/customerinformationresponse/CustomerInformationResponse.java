 ...
 *
 */
package id.co.maybank.esb.model.customerinformationresponse;

import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
import id.co.maybank.esb.model.customerinformationresponsedata.CustomerInformationResponseData;
import id.co.maybank.esb.model.responsedetail.ResponseDetail;
import lombok.*;
...
@JsonPropertyOrder({ "responseCode", "responseDetail", "CustomerInformationResponseData" })
